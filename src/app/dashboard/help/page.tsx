...
const allFaqs = [
  { q: "How do I create a listing on the marketplace?", a: "Navigate to Marketplace and click '+ Post Listing'. Fill in the title, description, price (if applicable), category, and add photos. Choose your listing type: Sell, Exchange, Giveaway, or Request. Your listing will be visible to the community instantly.", category: "Community" },
